...
test('CopsAndCrimsGunGame', () => {
  const data = new CopsAndCrimsGunGame({ stats: 'meow' });
  expect(data).toBeInstanceOf(CopsAndCrimsGunGame);
  expectTypeOf(data).toEqualTypeOf<CopsAndCrimsGunGame>();
