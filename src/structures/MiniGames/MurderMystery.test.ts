...
test('MurderMystery', () => {
  ...
  expect(data.goldPickedUp).greaterThanOrEqual(0);
  ...
  expect(data.killsAsMurderer).greaterThanOrEqual(0);
  ...
  expect(data.suicides).greaterThanOrEqual(0);
  ...
  expect(data.classic.goldPickedUp).greaterThanOrEqual(0);
