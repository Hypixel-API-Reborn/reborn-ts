...
import SkyWars, { SkywarsMode, SkywarsModeStats, SkywarsPackages, SkyWarsPrestige } from './SkyWars';
...
test('SkyWars', () => {
  ...
  expect(data.solo.normal.KDRatio).toBeDefined();
  expect(data.solo.normal.KDRatio).greaterThanOrEqual(0);
  expectTypeOf(data.solo.normal.KDRatio).toEqualTypeOf<number>();
  ...
  expect(data.solo.normal.WLRatio).toBeDefined();
  expect(data.solo.normal.WLRatio).greaterThanOrEqual(0);
  expectTypeOf(data.solo.normal.WLRatio).toEqualTypeOf<number>();
  ...
  expect(data.solo.insane.KDRatio).toBeDefined();
  expect(data.solo.insane.KDRatio).greaterThanOrEqual(0);
  expectTypeOf(data.solo.insane.KDRatio).toEqualTypeOf<number>();
  ...
  expect(data.solo.insane.WLRatio).toBeDefined();
  expect(data.solo.insane.WLRatio).greaterThanOrEqual(0);
  expectTypeOf(data.solo.insane.WLRatio).toEqualTypeOf<number>();
  ...
  expect(data.team.normal.KDRatio).toBeDefined();
  expect(data.team.normal.KDRatio).greaterThanOrEqual(0);
  expectTypeOf(data.team.normal.KDRatio).toEqualTypeOf<number>();
  ...
  expect(data.team.normal.WLRatio).toBeDefined();
  expect(data.team.normal.WLRatio).greaterThanOrEqual(0);
  expectTypeOf(data.team.normal.WLRatio).toEqualTypeOf<number>();
  ...
  expect(data.team.insane.KDRatio).toBeDefined();
  expect(data.team.insane.KDRatio).greaterThanOrEqual(0);
  expectTypeOf(data.team.insane.KDRatio).toEqualTypeOf<number>();
  ...
  expect(data.team.insane.WLRatio).toBeDefined();
  expect(data.team.insane.WLRatio).greaterThanOrEqual(0);
  expectTypeOf(data.team.insane.WLRatio).toEqualTypeOf<number>();
  ...
  expect(data.mega.KDRatio).toBeDefined();
  expect(data.mega.KDRatio).greaterThanOrEqual(0);
  expectTypeOf(data.mega.KDRatio).toEqualTypeOf<number>();
  ...
  expect(data.mega.WLRatio).toBeDefined();
  expect(data.mega.WLRatio).greaterThanOrEqual(0);
  expectTypeOf(data.mega.WLRatio).toEqualTypeOf<number>();
  ...
  expect(data.megaDoubles.KDRatio).toBeDefined();
  expect(data.megaDoubles.KDRatio).greaterThanOrEqual(0);
  expectTypeOf(data.megaDoubles.KDRatio).toEqualTypeOf<number>();
  ...
  expect(data.megaDoubles.WLRatio).toBeDefined();
  expect(data.megaDoubles.WLRatio).greaterThanOrEqual(0);
  expectTypeOf(data.megaDoubles.WLRatio).toEqualTypeOf<number>();
  ...
  expect(data.lab.KDRatio).toBeDefined();
  expect(data.lab.KDRatio).greaterThanOrEqual(0);
  expectTypeOf(data.lab.KDRatio).toEqualTypeOf<number>();
  ...
  expect(data.lab.WLRatio).toBeDefined();
  expect(data.lab.WLRatio).greaterThanOrEqual(0);
  expectTypeOf(data.lab.WLRatio).toEqualTypeOf<number>();
