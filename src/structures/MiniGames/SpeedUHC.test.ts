...
test('SpeedUHC', () => {
  ...
  expect(data.soloNormal.KDR).greaterThanOrEqual(0);
  ...
  expect(data.soloNormal.WLR).greaterThanOrEqual(0);
  ...
  expect(data.soloInsane.KDR).greaterThanOrEqual(0);
  ...
  expect(data.soloInsane.WLR).greaterThanOrEqual(0);
  ...
  expect(data.teamNormal.KDR).greaterThanOrEqual(0);
  ...
  expect(data.teamNormal.WLR).greaterThanOrEqual(0);
  ...
  expect(data.teamInsane.KDR).greaterThanOrEqual(0);
  ...
  expect(data.teamInsane.WLR).greaterThanOrEqual(0);
