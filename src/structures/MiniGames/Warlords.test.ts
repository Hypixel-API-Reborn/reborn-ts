...
test('Warlords', () => {
  ...
  expect(data.pyromancer.WLR).greaterThanOrEqual(0);
  ...
  expect(data.mage.WLR).greaterThanOrEqual(0);
  ...
  expect(data.thunderlord.WLR).greaterThanOrEqual(0);
  ...
  expect(data.earthwarden.WLR).greaterThanOrEqual(0);
  ...
  expect(data.aquamancer.WLR).greaterThanOrEqual(0);
  ...
  expect(data.avenger.WLR).greaterThanOrEqual(0);
  ...
  expect(data.warrior.WLR).greaterThanOrEqual(0);
  ...
  expect(data.defender.WLR).greaterThanOrEqual(0);
  ...
  expect(data.cryomancer.WLR).greaterThanOrEqual(0);
  ...
  expect(data.crusader.WLR).greaterThanOrEqual(0);
  ...
  expect(data.berserker.WLR).greaterThanOrEqual(0);
  ...
  expect(data.protector.WLR).greaterThanOrEqual(0);
  ...
  expect(data.revenant.WLR).greaterThanOrEqual(0);
  ...
  expect(data.spiritguard.WLR).greaterThanOrEqual(0);
