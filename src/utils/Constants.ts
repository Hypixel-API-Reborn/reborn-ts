...
export const petScore = { COMMON: 1, UNCOMMON: 2, RARE: 3, EPIC: 4, LEGENDARY: 5, MYTHIC: 6, VERY_SPECIAL: 6 };

export const petRarityOffset = { COMMON: 0, UNCOMMON: 6, RARE: 11, EPIC: 16, LEGENDARY: 20, MYTHIC: 20 };
...
/* eslint-disable camelcase */ export const bestiary = {
  dynamic: {
    name: 'Private Island',
    mobs: [
