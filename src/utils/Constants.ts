...
export const skyblockSkillLevelingXp = [
...
export const SkyblockDungeonXp = [
  ...
  60000000, 75000000, 93000000, 116250000, 200000000
];

export const SkyblockHotmXp = [0, 3000, 9000, 25000, 60000, 100000, 150000, 210000, 290000, 400000];

export const SkyblockSocialXp = [
...
export const SkyblockGarden = [0, 70, 70, 140, 240, 600, 1500, 2000, 2500, 3000, 10000, 10000, 10000, 10000, 10000];

export const SkyblockGardenCropMilestones = {
  wheat: [
  ...
  melon: [
    ...
    15000000, 15000000, 15000000, 1500000, 15000000, 15000000
  ],
  pumpkin: [
    30, 50, 80, 170, 330, 670, 1330, 2500, 3500, 5000, 6500, 8000, 10000, 20000, 35000, 50000, 75000, 100000, 175000,
    250000, 350000, 500000, 750000, 1000000, 1300000, 1600000, 2000000, 2300000, 2600000, 3000000, 3000000, 3000000,
...
export const SkyblockPetScore = { COMMON: 1, UNCOMMON: 2, RARE: 3, EPIC: 4, LEGENDARY: 5, MYTHIC: 6 };

export const SkyblockPetRarityOffset = { COMMON: 0, UNCOMMON: 6, RARE: 11, EPIC: 16, LEGENDARY: 20, MYTHIC: 20 };

export const SkyblockPetLevels = [
...
export const SkyWarsPrestigeIcons = {
  default: '⋆',
  angel_1: '★',
  angel_2: '☆',
  angel_3: '⁕',
